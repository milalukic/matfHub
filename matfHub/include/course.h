...
public:
  ...
  Course(const std::string &desc, int d, const std::string &t, int s, int dur,
         const std::string &type, const std::set<std::string> &grps,
         std::string &clsrm, const std::set<std::string> &mods,
         const std::set<int> &yrs, const std::set<std::string> &subgrps);
};
