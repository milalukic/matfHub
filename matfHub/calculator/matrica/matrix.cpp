...
void Matrix::data(arma::mat Matrix){
    *(this->_data) = Matrix;
    ...
    //operators
//TODO make this dynamic (new doens't work)(try returning Matrix*)
Matrix Matrix::operator + (const Matrix &other) const{
    ...
    Matrix new_mat = Matrix(dimension1(), dimension2(), "zbir");
...
Matrix Matrix::operator ++(int){
    Matrix tmp = Matrix(dimension1(), dimension2(), "postfix");
    ++(*this);
    return tmp;
} 
...
Matrix Matrix::ones(){
    ...
    Matrix new_mat = Matrix(dimension1(), dimension2(), "Ones");
    new_mat.data(new_data);
...
Matrix Matrix::diag(){
    ...
    Matrix new_mat = Matrix(dimension1(), dimension2(), "E");
    new_mat.data(new_data);
